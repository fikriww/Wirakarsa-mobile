              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    _buildAnalysisItem(Icons.list_alt, const Color(0xFFE1F0FF), "Structure & Completeness", "Photo, contact details, summary, and more"),
                    ...
                    _buildAnalysisItem(Icons.bookmark_outline, const Color(0xFFE1F0FF), "ATS Score & Readability", "How easily your CV can be read and evaluated by recruiters"),
                    _buildAnalysisItem(Icons.error_outline, const Color(0xFFE1F0FF), "Specific Improvement Suggestions", "What to add and what to refine"),
                    const SizedBox(height: 40),
                  ],
                ),
              ),
